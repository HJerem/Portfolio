...
<head>
  ...
  <title>Jérémy Halin | Expérimentations</title>
...
<section class="container-1024">
  <ul class="experiments">
    <a href="google-maps-location"><li><h3>Géolocalisation avec l'API Google Maps v3<i class="fa fa-arrow-right"></i></h3></li></a>
    <a href="google-maps-location"><li><h3>Géolocalisation avec l'API Google Maps v3<i class="fa fa-arrow-right"></i></h3></li></a>
    <a href="google-maps-location"><li><h3>Géolocalisation avec l'API Google Maps v3<i class="fa fa-arrow-right"></i></h3></li></a>
    <a href="google-maps-location"><li><h3>Géolocalisation avec l'API Google Maps v3<i class="fa fa-arrow-right"></i></h3></li></a>
  </ul> 
